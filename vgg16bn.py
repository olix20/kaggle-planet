...
#mean per channel including train and test: (77.005074, 87.658783, 80.211067) only training (77.088875, 87.727234, 80.300789)

#vgg_mean = np.array([77.0050, 87.6587, 80.2110], dtype=np.float32).reshape((3,1,1))
...
class Vgg16BN():
    ...
    def get_batches(self, path, gen=image.ImageDataGenerator(), shuffle=True, batch_size=8, class_mode='categorical',\
        size=(224,224)):
        return gen.flow_from_directory(path, target_size=size,
