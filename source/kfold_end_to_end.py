...
if __name__ == "__main__":
	...
	for train_index, valid_index in kf.split(x_train,y_train):
		...
		kfold_weights_path = os.path.join('weights/', 'vgg1_weights_kfold_{}of{}.h5'.format( str(current_fold),nfolds))
		...
		train_batch = train_gen.flow(X_train,Y_train,batch_size=batch_size,shuffle=False,seed=current_fold)
		
		######## ACTION
		history = end_to_end_model.fit_generator(train_batch, steps_per_epoch=2*len(X_train)/batch_size,
