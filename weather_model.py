...
if __name__ == '__main__':
	...
	for train_index, valid_index in kf.split(y_train):
		...
		print_and_log('Start KFold number {} from {}'.format(current_fold, n_folds))
...
#         print(local_best_thresholds)
		...
		report = classification_report(Y_valid, p_valid> local_best_thresholds, target_names=weather_labels)
